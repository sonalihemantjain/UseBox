...
// Splits step.content into Concept / Why / Steps sections
      ...
      <div className="w-full px-4 sm:px-8 lg:px-12 py-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* ═════════════ RIGHT PANEL — Overview / Step Detail ═════════════ */}
            <div className="lg:col-span-2">
              ...
              {readingStep ? (
                            ...
                            <div>
                              ...
                              <div className="rounded-xl border border-border bg-muted/30 px-4 py-4">
                                <div className="prose prose-sm dark:prose-invert max-w-none
                                  ...
                                  [&_li]:pl-1
                                  [&_code]:bg-slate-900 [&_code]:text-slate-100 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-xs
                                  [&_pre]:bg-slate-900 [&_pre]:text-slate-100 [&_pre]:rounded-lg [&_pre]:border-0 [&_pre_code]:bg-transparent [&_pre_code]:text-slate-100">
                ...
                <div className="rounded-2xl bg-card border border-border overflow-hidden">
                  ...
                  {/* Overview body — renders Scenario / Goal / Prereqs / Input Data / Expected Output */}
                  <div className="px-8 py-7">
                    <div className="prose prose-sm dark:prose-invert max-w-none
                      ...
                      [&_code]:bg-slate-900 [&_code]:text-slate-100 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-sm [&_code]:font-mono
                      [&_pre]:bg-slate-900 [&_pre]:text-slate-100 [&_pre]:rounded-xl [&_pre]:border-0 [&_pre]:p-4 [&_pre]:my-3 [&_pre]:overflow-x-auto
